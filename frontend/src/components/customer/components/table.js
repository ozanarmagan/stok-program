...
const headCells = [
  ...
  { id: 'remainingDebt', numeric: false, disablePadding: false, label: 'Kalan Borç' },
  { id: 'note', numeric: false, disablePadding: false, label: 'Not' },  
  { id: 'date', numeric: false, disablePadding: false, label: 'Tarih' },
  { id: 'process', numeric: false, disablePadding: false, label: 'İşlemler' },  
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.productsNumber}</TableCell>
                      <TableCell align="center">{row.sum}</TableCell>
                      <TableCell align="center">{row.remainingDebt}</TableCell>
